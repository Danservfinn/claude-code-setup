 ...
 *
 * Usage:
 *   STRIPE_SECRET_KEY=sk_live_... MERCURY_ROUTING=... MERCURY_ACCOUNT=... npx tsx scripts/link-mercury-account.ts
 */
...
if (!routingNumber || !accountNumber) {
  ...
  console.error('  npx tsx scripts/link-mercury-account.ts')
