 ...
 *
 * Usage:
 *   STRIPE_SECRET_KEY=sk_test_... npx tsx setup-stripe-products.ts
 *
 * For production:
 *   STRIPE_SECRET_KEY=sk_live_... npx tsx setup-stripe-products.ts
 */
...
async function setupStripeProducts() {
  ...
  console.log('\n\nSetup Complete!')
  console.log('===============\n')
  console.log('Environment Variables to add to .env or Railway:\n')
...
if (!process.env.STRIPE_SECRET_KEY) {
  ...
  console.error('Usage: STRIPE_SECRET_KEY=sk_test_... npx tsx setup-stripe-products.ts')
  process.exit(1)
}
